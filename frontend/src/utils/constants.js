...
export const QUIZ_STEPS = [
  {
    ...
    options: [
      { label: 'Rose poudré & Blanc', value: 'romantique', emoji: '🌸', image: 'https://placehold.co/200x150/E8C4C4/1A1A2E?text=Rose+Blanc' },
      { label: 'Pastel & Naturel', value: 'boheme', emoji: '🌿', image: 'https://placehold.co/200x150/7D9B76/FFFFFF?text=Pastel' },
      { label: 'Or & Nuit', value: 'luxe', emoji: '✨', image: 'https://placehold.co/200x150/C9A96E/FFFFFF?text=Or+Nuit' },
      { label: 'Vert & Blanc', value: 'champetre', emoji: '🌻', image: 'https://placehold.co/200x150/8B9E8A/FFFFFF?text=Vert+Blanc' },
    ],
  },
  {
    key: 'lieu',
    ...
    options: [
      { label: 'Château historique', value: 'romantique', emoji: '🏰' },
      { label: 'Domaine champêtre', value: 'champetre', emoji: '🌳' },
      { label: 'Plage paradisiaque', value: 'boheme', emoji: '🏖️' },
      { label: 'Loft urbain', value: 'moderne', emoji: '🏙️' },
    ],
  },
  {
    key: 'musique',
    ...
    options: [
      { label: 'Orchestre classique', value: 'luxe', emoji: '🎻' },
      { label: 'Jazz intimiste', value: 'romantique', emoji: '🎷' },
      { label: 'DJ & Dancefloor', value: 'moderne', emoji: '🎧' },
      { label: 'Acoustique folk', value: 'boheme', emoji: '🎸' },
    ],
  },
  {
    key: 'dress_code',
    ...
    options: [
      { label: 'Élégance classique', value: 'luxe', emoji: '👔' },
      { label: 'Romantique & fluide', value: 'romantique', emoji: '👗' },
      { label: 'Décontracté chic', value: 'boheme', emoji: '🧢' },
      { label: 'Moderne & audacieux', value: 'moderne', emoji: '👠' },
    ],
  },
  {
    key: 'priorite',
    ...
    options: [
      { label: 'Des photos à couper le souffle', value: 'romantique', emoji: '📸' },
      { label: 'Une décoration spectaculaire', value: 'luxe', emoji: '💐' },
      { label: 'Une gastronomie exceptionnelle', value: 'moderne', emoji: '🍽️' },
      { label: 'Une ambiance inoubliable', value: 'boheme', emoji: '🎉' },
    ],
  },
];
